// PluginsPage — `mise registry --json` rendered as a browsable table
// of tool shorthands and their backends (issue #29). The page has a
// search filter and is read-only.
...
import { Badge, EmptyState, PageShell, Table, type TableColumn } from "../../components";
import { useParsedRegistry } from "../../hooks/useIssue29";
import type { RegistryItem } from "../../types/tauri";
...
export function PluginsPage() {
  ...
  const columns: TableColumn<RegistryItem>[] = [
    {
      key: "short",
      ...
      <div className={styles.page}>
        ...
        <div className={styles.toolbar}>
          ...
          <button
            ...
            onClick={() => void queryClient.invalidateQueries({ queryKey: ["registry", cwd] })}
