...
//
// Shows a globe icon + the current locale. Menu triggers carry no caret
// glyph (beta8, issue #98) — expandability is conveyed by interaction.
// Clicking opens a menu of supported languages rendered
