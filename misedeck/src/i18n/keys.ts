...
export const I18N_KEYS = {
  ...
  tools: {
    ...
    versionCenter: {
      installedTitle: "tools.versionCenter.installedTitle",
      availableTitle: "tools.versionCenter.availableTitle",
      activeBadge: "tools.versionCenter.activeBadge",
      installedBadge: "tools.versionCenter.installedBadge",
      created: "tools.versionCenter.created",
      filterPlaceholder: "tools.versionCenter.filterPlaceholder",
      emptyInstalledTitle: "tools.versionCenter.emptyInstalledTitle",
