...
Last updated: 2026-09-02 — beta4 round in progress; #49 (sidebar chrome), #50 (Tools data honesty), and #57 (table layout discipline) done; #54, #55/#56 unblocked; #58/#59 now unblocked by #57.
...
- 8 user feedback items + a two-track full-app audit (visual + product/UX) were aligned with the owner and published:
  ...
  - Startable now (no blockers): **#46** async Tauri commands, **#47** title bar follows theme, **#48** Preview/Global/vocab, **#51** Plugins page, **#52** Settings editing, **#53** a11y, **#54** footer controls (unblocked by #49, now closed), **#55/#56** (unblocked by #50, now closed), **#58/#59** (unblocked by #57, now closed).
  - Blocked: #60 (visual sweep, last) ←#54,#57,#59.
