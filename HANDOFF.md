...
- 8 user feedback items + a two-track full-app audit (visual + product/UX) were aligned with the owner and published:
  ...
  - Startable now (no blockers): **#46** async Tauri commands, **#52** Settings editing, **#53** a11y, **#55/#56** (unblocked by #50, now closed), **#58/#59** (unblocked by #57, now closed). (#47 title bar follows theme: done, 366c079. #48 Preview/Global/vocab: done, aa857fb. #51 Plugins page: done, b765193.)
