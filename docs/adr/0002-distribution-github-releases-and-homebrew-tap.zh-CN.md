...
> [English](./0002-distribution-github-releases-and-homebrew-tap.md)
...
- 被列入 mise 官方文档（community projects）以及双语 README 关键词是主要的发现渠道；产品命名为 **MiseDeck**（GitHub 仓库 `cherishfall/mise-ui` 可能改名；GitHub 会保留重定向）。SEO 说明：名称匹配只是次要因素 —— 文档收录、GitHub topics 和双语 README 关键词才是大头。
