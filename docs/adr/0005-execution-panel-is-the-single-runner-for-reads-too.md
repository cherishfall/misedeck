...
- `tools_ls`, `tools_ls_tool`, and `tools_ls_remote` lost their Tauri commands and frontend wrappers in #96; what remains is the Rust runner functions and their fixture tests, kept as the pinned argv contract. The UI dispatches all three reads through the panel runner in background mode.
