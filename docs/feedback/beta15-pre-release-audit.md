...
全部问题按波次出票，SPEC parent = **#201**：

- 波次 1（发版前必修）：#202（A1+A5）、#203（A2+A3）、#204（A4）、#205（B1-B3）、#206（D1+D2）、#207（C）
- 波次 2（P2 清理）：#208（E1 Windows）、#209（P2 前端 1-6）、#210（P2 后端 7-13）、#211（P2 UI 14-19）、#212（P2 i18n）、#213（P2 旅程 20/22-25/27/28）、#214（P2 旅程 21/26/29）
- 平台决策（owner 拍板）：本版不发 Windows 包（targets 收窄 + release notes 声明），Linux 保留但标注未实测；软取消真 kill 独立 feature 另立，本版发布说明披露。
